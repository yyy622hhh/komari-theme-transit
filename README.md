...
- 当前稳定版：[v1.0.31](https://github.com/yyy622hhh/komari-theme-transit/releases/tag/v1.0.31)
...
- 第 2 段可自动匹配落地机名称或城市名（例如任务 `Tokyo` 对应节点“东京-高负载”），也可从该线路机的 Ping 任务里手选；对不上不会乱绑。
