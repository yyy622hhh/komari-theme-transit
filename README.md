...
- 当前稳定版：[v1.0.34](https://github.com/yyy622hhh/komari-theme-transit/releases/tag/v1.0.34)
...
保存后等至少一个采样周期。第 2 段新建任务需要线路机先打到落地机 IP。数据已过期或刷新失败时，页面会明确显示降级状态。
