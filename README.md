...
- 当前稳定版：[v1.0.33](https://github.com/yyy622hhh/komari-theme-transit/releases/tag/v1.0.33)
...
| 拓扑管理 | 选入口、线路机和落地机后添加或修改，立即保存并自动创建或复用 ICMP 探测任务   |
...
- 拓扑管理改为只选入口、线路机和落地机；添加和修改立即保存，并按落地机地址自动创建或复用 ICMP 任务。
