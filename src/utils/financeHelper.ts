...
import type { CurrencyCode, ExchangeRates, ExchangeRateSource } from '@/utils/financeCore'
import {
  ...
  getPriceCNY,
  normalizeCurrency,
} from '@/utils/financeCore'
import { logAppWarning } from '@/utils/safeError'
import { isFreeNode } from '@/utils/tagHelper'

export type { CurrencyCode, ExchangeRates, ExchangeRateSource } from '@/utils/financeCore'
export {
  calculateMonthlyCostCNY,
  CURRENCY_SYMBOLS,
  DEFAULT_EXCHANGE_RATES,
