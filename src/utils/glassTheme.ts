...
const PRESET_TOKENS: Record<Exclude<GlassColorPreset, 'custom'>, GlassThemeTokens> = {
  emerald: {
    lightCard: '#ffffffb3',
    lightCardHover: '#ffffffc7',
    lightControl: '#ffffffe0',
    lightHeader: '#ffffffc7',
    lightText: '#10151c',
  ...
  soft: {
    lightCard: '#ffffffe0',
    lightCardHover: '#fffffff0',
    lightControl: '#ffffffe8',
    lightHeader: '#ffffffe8',
    lightText: '#14151a',
    lightMutedText: '#4b5563',
    lightBorder: '#ffffffa6',
  ...
  contrast: {
    lightCard: '#fffffff2',
    lightCardHover: '#ffffffff',
    lightControl: '#fffffff2',
    lightHeader: '#fffffff2',
    lightText: '#080b12',
    lightMutedText: '#1f2937',
    lightBorder: '#ffffffcc',
